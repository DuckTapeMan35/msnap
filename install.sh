...
echo "Installing mutil to $CONFIG_DIR/mutil"
mkdir -p "$CONFIG_DIR/mutil"
cp "$TMP/mutil/shell.qml" "$CONFIG_DIR/mutil/"
cp "$TMP/mutil/RegionSelector.qml" "$CONFIG_DIR/mutil/"
...
echo "✔ mutil → $CONFIG_DIR/mutil"
echo
echo "Launch mutil with:"
echo "    qs -p $CONFIG_DIR/mutil"
echo
